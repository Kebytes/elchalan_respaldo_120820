                ...
                <div class="toolbox-left">
                    <div class="toolbox-item toolbox-sort">
                        <div class="select-custom">
                            ...
                            <asp:DropDownList runat="server" ID="OpcionesOrdenacion" AutoPostBack="true" OnSelectedIndexChanged="OpcionesOrdenacion_SelectedIndexChanged" CssClass="form-control">
                                <asp:ListItem Value="None" Text="Ordenar" disabled="disabled"></asp:ListItem>
                                <asp:ListItem Value="asc" Text="Ordenar por precio: menor a mayor"></asp:ListItem>
                                <asp:ListItem Value="desc" Text="Ordenar por precio: mayor a menor"></asp:ListItem>
                            </asp:DropDownList>
